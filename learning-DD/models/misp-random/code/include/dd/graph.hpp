...
struct Graph_BDD2 {
    ...
    Graph_BDD2(Graph_BDD2* graph, vector<int>& mapping);
 ...
 * Empty constructor
 */
inline Graph_BDD2::Graph_BDD2() : n_vertices(0), n_edges(0) {
 ...
 */
inline bool Graph_BDD2::is_adj(int i, int j) {
    assert(i >= 0);
    assert(j >= 0);
    assert(i < n_vertices);
    assert(j < n_vertices);
 ...
 */
inline void Graph_BDD2::set_adj(int i, int j) {
    assert(i >= 0);
    assert(j >= 0);
    assert(i < n_vertices);
    assert(j < n_vertices);
