...
#ifndef INSTANCE_HPP2_
#define INSTANCE_HPP2_
 ...
 * Independent set instance structure
 */
struct IndepSetInst2 {


    Graph_BDD2*              graph;             /**< independent set graph */
 ...
 */
inline void IndepSetInst2::read_DIMACS(const char *filename) {

  cout << "Reading instance " << filename << endl;

  // read graph
  graph = new Graph_BDD2;
 ...
 * Read DIMACS independent set instance with no costs
 */
inline void IndepSetInst2::build_instance_from_edge_list(vector< pair<int, int> > edge_list,set<int> covered_set) {
...
inline void IndepSetInst2::build_complete_instance(std::vector< std::vector< std::pair<int, double> > > adj) {
 ...
 * Read DIMACS independent set instance
 */
inline int IndepSetInst2::read_DIMACS_with_costs(const char *filename, const char* costs_file, const char* params_file) {
