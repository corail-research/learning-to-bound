...
int MinInState2::vertex_in_layer(BDD2* bdd, int layer) {
	return -1;
}

// randomized min in state heuristic
int RandomizedMinInState22::vertex_in_layer(BDD2* bdd, int layer) {
	return -1;
}

// fixed ordering
void FixedOrdering2::read_ordering(char* filename) {
...
void MinDegreeOrdering2::construct_ordering() {
...
void MaximalPathDecomp2::construct_ordering() {
...
void CutVertexDecomposition2::identify_components(vector< vector<int> > &comps, vector<bool> &is_in_graph) {
...
vector<int> CutVertexDecomposition2::find_ordering(vector<bool> is_in_graph) {
...
void CutVertexDecomposition2::construct_ordering() {
...
void CutVertexDecomposition2GeneralGraph2::identify_components(vector< vector<int> > &comps, vector<bool> &is_in_graph) {
...
vector<int> CutVertexDecomposition2GeneralGraph2::find_ordering(vector<bool> is_in_graph) {
...
void CutVertexDecomposition2GeneralGraph2::construct_ordering() {
...
void CutVertexDecomposition2GeneralGraph2::restrict_graph() {
	...
	IntComparator2 int_comp(degrees);
...
void CutVertexDecomposition2GeneralGraph2::regenerate_graph() {
